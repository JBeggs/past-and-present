...
describe('ProductCard', () => {
  ...
  it('renders product image when provided', () => {
    const product = { ...baseProduct, image: 'https://example.com/image.jpg' };
  ...
  it('shows New tag when product has non-vintage tags', () => {
    const product = { ...baseProduct, tags: ['modern', 'minimal'] };
    render(<ProductCard product={product} />);
    expect(screen.getByText('New')).toBeInTheDocument();
  });
  ...
  it('renders description when provided', () => {
    const product = { ...baseProduct, description: 'A lovely test product' };
    render(<ProductCard product={product} />);
