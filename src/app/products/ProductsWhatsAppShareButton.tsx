...
export default function ProductsWhatsAppShareButton({
  ...
  return (
    <a
      ...
      className="flex w-full max-w-md mx-auto items-center justify-center gap-2 rounded-full bg-[#25D366] py-3 px-6 text-base font-medium text-white transition-colors hover:bg-[#20bd5a] active:scale-95"
    >
